...
describe('Component Tests', () => {
  describe('StdCodesGroup Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      stdCodesGroupServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(stdCodesGroupServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(stdCodesGroupServiceStub.retrieve.callCount).toEqual(3);
