...
import net.atos.etax.config.Constants;
import net.atos.etax.config.audit.AuditEventConverter;
import net.atos.etax.domain.PersistentAuditEvent;
...
import static net.atos.etax.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
