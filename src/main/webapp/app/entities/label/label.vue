<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('etaxApp.label.home.title')" id="label-heading">Labels</span>
            <router-link :to="{name: 'LabelCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-label">
                ...
                <span  v-text="$t('etaxApp.label.home.createLabel')">
                    Create new Label
                </span>
            </router-link>
        </h2>
        ...
        <div class="alert alert-warning" v-if="!isFetching && labels && labels.length === 0">
            <span v-text="$t('etaxApp.label.home.notFound')">No labels found</span>
        </div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="etaxApp.label.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-label-heading" v-bind:title="$t('etaxApp.label.delete.question')">Are you sure you want to delete this Label?</p>
            </div>
