...
export default class Uiapp extends Vue {
  ...
  public prepareRemove(instance: IUiapp): void {
    this.removeId = instance.id;
  }

  public removeUiapp(): void {
    this.uiappService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('etaxApp.uiapp.deleted', { param: this.removeId });
