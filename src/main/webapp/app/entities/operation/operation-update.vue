    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="etaxApp.operation.home.createOrEditLabel" v-text="$t('etaxApp.operation.home.createOrEditLabel')">Create or edit a Operation</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('etaxApp.operation.date')" for="operation-date">Date</label>
                        <div class="d-flex">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('etaxApp.operation.description')" for="operation-description">Description</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('etaxApp.operation.amount')" for="operation-amount">Amount</label>
                    ...
                    <div class="form-group">
                        <label v-text="$t('etaxApp.operation.label')" for="operation-label">Label</label>
                        <select class="form-control" id="operation-label" multiple name="label" v-model="operation.labels">
                            <option v-bind:value="getSelected(operation.labels, labelOption)" v-for="labelOption in labels" :key="labelOption.id">{{labelOption.label}}</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('etaxApp.operation.bankAccount')" for="operation-bankAccount">Bank Account</label>
