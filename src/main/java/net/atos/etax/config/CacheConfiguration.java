...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, net.atos.etax.domain.Uiapp.class.getName() + ".resources");
            createCache(cm, net.atos.etax.domain.Resource.class.getName());
            createCache(cm, net.atos.etax.domain.Resource.class.getName() + ".uiapps");
            createCache(cm, net.atos.etax.domain.Privilege.class.getName());
            createCache(cm, net.atos.bpm.domain.Deputy.class.getName());
            createCache(cm, net.atos.bpm.domain.DeputyToDo.class.getName());
