...
public class OfficeTaxFuncResource {
    ...
    public ResponseEntity<List<OfficeTaxFunc>> getAllOfficeTaxFuncs(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of OfficeTaxFuncs");
        Page<OfficeTaxFunc> page = officeTaxFuncRepository.findAll(pageable);
