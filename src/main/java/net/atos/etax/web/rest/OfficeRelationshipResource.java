...
public class OfficeRelationshipResource {
    ...
    public ResponseEntity<List<OfficeRelationship>> getAllOfficeRelationships(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of OfficeRelationships");
        Page<OfficeRelationship> page = officeRelationshipRepository.findAll(pageable);
